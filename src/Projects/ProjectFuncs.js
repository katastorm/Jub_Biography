...
///Obtenir une liste de bubbles décoratives a partir de la liste de string
const GetProjectTagsToBubbles = (tags) => {
  ...
  tags.forEach(t => {
      result.push(<span key={k++} className='BubbleSpan'>{t}</span>)
  })
...
export { GetPreview, ProjectPopup, GetMonthName, GetProjectInfos_TableMode, GetProjectTagsToBubbles };